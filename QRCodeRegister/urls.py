...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.as_view(
         template_name='register_app/logout.html'
         ), name='logout'),
    ...
    path('register/', register_views.register,
         name='register'),
    path('user_dashboard/', register_views.user_dashboard,
         name='user_dashboard'),
    path('sign_in_out/<int:location_id>/',
         register_views.sign_in_out_view, name='sign_in_out'),
